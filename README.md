![bezeye-840x472-7-original.gif](https://xyzzy.github.io/bezeye/bezeye-840x472-7-original.gif)

# Welcome to the Wonderful World of Bezeye

Bezeye is an animated GIF showcasing Bezier Curve Texture+Movement and Spatial Color Quantization.  
...
Outline and texture of the wings are Bezier curve based.  
Choreography is storyboard driven and stored as Bezier curves.

## Bezier curves

Natural movement is always in motions, direction changes gradually and never abrupt.  
Bezier curves are cubic polynomials that create patterns found in nature.  
The curve algorithms are from the Closed Continious Bezier Curve project `ccbc` that re-masters the maths.  
...
Below is a small interactive demonstration of a 10-point re-amastered curve:
...
<p><a href="https://rockingship.github.io/bezeye/ccbc-10point.html"><img class="thumb" src="assets/ccbc-10point-300x300.png" alt="animated preview" width="300" height="300"></a><br/>

## Wings

Wing texture is created by rendering a Bezier curve and moving its on-curve control points.  
...
<p><a href="https://rockingship.github.io/bezeye/wing.webp"><img class="thumb" src="assets/wing-237x300.png" alt="animated preview" width="237" height="300"></a><br/>
...
<p><a href="https://rockingship.github.io/bezeye/Compare.md"><img class="thumb" src="assets/sbs-534x300-7.png" alt="compare palettes" width="534" height="300"></a><br/>
...
<p><a href="https://rockingship.github.io/bezeye/storyboard.html"><img class="thumb" src="assets/storyboard-534x300.png" alt="storyboard" width="534" height="300"></a><br/>

# Original entry

The original entry was a collaboration with Hopscotch who supplied the Bezier outlines and storyboard settings.  
...
<p><a href="https://rockingship.github.io/bezeye/bezeye-840x472-7-original.gif"><img class="thumb" src="assets/bezeye-534x300-7-original.png" alt="original" width="534" height="300"></a><br/>
...
Render true-colour bezier based texture for wings
